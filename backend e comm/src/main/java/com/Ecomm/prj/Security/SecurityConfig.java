    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Allow CORS Pre-flight Options
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()

                        // Public Auth & AI Agent Endpoints
                        .requestMatchers("/api/auth/**").permitAll()
                        .requestMatchers("/chat", "/chat/**", "/api/chat", "/api/chat/**").authenticated()
                        ...
                        // Cart & Wishlist allowed publicly for seamless agent actions
                        .requestMatchers("/cart/**", "/api/cart/**").permitAll()
                        .requestMatchers("/wishlist/**", "/api/wishlist/**").permitAll()
